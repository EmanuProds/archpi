...
> **Modern and interactive post-installation configuration for Arch Linux** - Transform your new system installation into a complete development workstation in just a few minutes!
...
1. **Download script:**
   ```bash
   git clone https://github.com/EmanuProds/archpi.git
   cd archpi
   ```
